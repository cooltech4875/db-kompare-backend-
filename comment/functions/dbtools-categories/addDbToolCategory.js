// Add DB Tool Category Handler
// This endpoint creates a new DB Tool Category
...
export const handler = async (event) => {
  try {
    ...
    return sendResponse(
      200,
      "DB Tool Category added successfully",
      categoryItem
    );
  } catch (error) {
    console.error("Error adding DB Tool Category:", error);
