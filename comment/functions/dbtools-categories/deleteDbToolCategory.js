// Delete DB Tool Category Handler
// This endpoint deletes a DB Tool Category by ID
...
export const handler = async (event, context, callback) => {
  try {
    ...
    if (!existing || !existing.Item) {
      return sendResponse(404, "DB Tool Category not found", null);
    }
    ...
    return sendResponse(
      200,
      "DB Tool Category deleted successfully",
      deleted.Attributes
    );
  } catch (error) {
    console.error("Error deleting DB Tool Category:", error);
